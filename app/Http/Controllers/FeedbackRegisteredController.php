...
class FeedbackRegisteredController extends Controller
{
    ...
    {
        $feedbackReg = FeedbackRegistered::paginate(4);
        if($feedbackReg->isEmpty()){
            return redirect('noFeedback');
        
        }
        else{
            return view('feedback-view')->with(['feedbackReg' => $feedbackReg]);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/feedback-view')->with('success','Feedback entries deleted successfully');
    }
    ...
    {
        $feedbackReg = FeedbackRegistered::orderBy('created_at', 'desc')->paginate(4);
