...
class FeedbackPublicController extends Controller
{
    ...
    {
        $feedbackPublic = FeedbackPublic::all();
    ...
    public function destroy($id)
    {
        ...
        // $feedbackAll = FeedbackPublic::all();
        ...
        // FeedbackPublic::where('id', $id)->delete();
        // return "Deleted";
    }
    ...
    // {
    //     $feedbackPublic = FeedbackPublic::orderBy('created_at', 'desc');

    //     if($feedbackPublic->isEmpty()){
    //         return redirect('feedback-management')->with('success', 'No feedback found!');
