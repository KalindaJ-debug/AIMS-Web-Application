...
<html lang="en">
    ...
    <!-- style="background-color:#2E933C;" -->
        ...
        <div class="container" style="background-color:white;">
            ...
            <h2 class="display-4">Device Management</h2>
            ...
            <table class="table" id="deviceTable"> 
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row">{{ $categories->name }}</th>
                        <td>
                            <button type="button" class="btn btn-warning" onclick='editDevice(@json($categories->name), @json($categories->id))'><i class="fas fa-edit"></i> Edit</button>
                            <button type="button" class="btn btn-danger" onclick='deleteDevice(@json($categories->id))'><i class="fas fa-trash"></i> Delete</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
