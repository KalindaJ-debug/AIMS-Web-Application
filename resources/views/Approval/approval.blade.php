            ...
            <table id="harvestTable" class="display table">
                ...
                @foreach ($cultivation as $cultivations)
                    <tr> 
                        ...
                        @endif</td>
                        <td><a class="btn btn-outline-primary" href="{{ url('cultivationDescription/'.$cultivations[0].'' ) }}">View</a></td>
                ...
                @foreach ($harvest as $harvests)
                    <tr> 
                        ...
                        @else
                            <p style='color:red'>Declined</p>
                        @endif</td>
                        <td><a class="btn btn-outline-primary" href="{{ url('harvestDescription/'.$harvests[0].'' ) }}">View</a></td>
                        <!-- <td><button type="button" class="btn btn-dark">Land Details</button></td> -->  
                    </tr> 
                @endforeach        
                </tbody>
